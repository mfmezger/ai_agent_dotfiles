...
description: Use this agent when you need to manage, organize, or clean up documentation and notes vaults. Handles markdown formatting, structural organization, content enhancement, and metadata management.
---
