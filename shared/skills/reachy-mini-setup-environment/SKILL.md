---
name: reachy-mini-setup-environment
description: "Reachy Mini environment setup workflow for preparing local resources, tools, and reference apps for development."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/setup-environment.md
---
