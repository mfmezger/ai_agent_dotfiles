---
name: reachy-mini-safe-torque
description: "Reachy Mini safety guidance for enabling and disabling motor torque without head drops, jumps, or mixed-state issues."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/safe-torque.md
---
