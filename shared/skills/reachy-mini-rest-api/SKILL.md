---
name: reachy-mini-rest-api
description: "Reachy Mini REST and WebSocket API guide for controlling the robot from web apps, other languages, and remote systems."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/rest-api.md
---
