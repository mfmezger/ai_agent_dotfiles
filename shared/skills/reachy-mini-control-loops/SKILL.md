---
name: reachy-mini-control-loops
description: "Reachy Mini guidance for real-time control loops, continuous set_target updates, and reactive motion architecture."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/control-loops.md
---
...
If the app only needs choreographed, predetermined motions, use `goto_target()` instead (see `reachy-mini-motion-philosophy.md`).
