---
name: reachy-mini-motion-philosophy
description: "Reachy Mini guidance for choosing between goto_target and set_target and structuring motion behavior correctly."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/motion-philosophy.md
---
...
See `reachy-mini-control-loops.md` for implementation details.
