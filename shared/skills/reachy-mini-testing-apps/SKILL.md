---
name: reachy-mini-testing-apps
description: "Reachy Mini app testing workflow covering simulation, physical robot validation, and pre-release checks."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/testing-apps.md
---
