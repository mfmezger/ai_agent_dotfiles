---
name: reachy-mini-create-app
description: "Reachy Mini workflow for creating new Python apps with the app assistant, proper templates, and Hugging Face publishing."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/create-app.md
---
