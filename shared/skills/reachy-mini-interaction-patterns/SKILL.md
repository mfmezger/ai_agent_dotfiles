---
name: reachy-mini-interaction-patterns
description: "Reachy Mini interaction design patterns using antennas, head motion, and other robot-native input mechanisms."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/interaction-patterns.md
---
...
> If `~/reachy_mini_resources/` doesn't exist, run `skills/reachy-mini-setup-environment.md` to clone reference apps.
