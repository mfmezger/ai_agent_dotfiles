---
name: reachy-mini-ai-integration
description: "Reachy Mini guidance for building LLM-driven, voice-enabled, and autonomous robot apps with clean tool-to-motion separation."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/ai-integration.md
---
