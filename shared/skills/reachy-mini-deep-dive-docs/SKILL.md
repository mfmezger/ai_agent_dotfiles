---
name: reachy-mini-deep-dive-docs
description: "Reachy Mini documentation map for finding SDK, API, platform, and source-level references for advanced questions."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/deep-dive-docs.md
---
...
External reference apps (run `skills/reachy-mini-setup-environment.md` to clone, or browse online):
