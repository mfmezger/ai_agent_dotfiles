---
name: reachy-mini-symbolic-motion
description: "Reachy Mini guidance for defining rhythmic or parameterized motion symbolically instead of using recorded frame data."
license: Apache-2.0
metadata:
  author: https://github.com/pollen-robotics
  source-repo: https://github.com/pollen-robotics/reachy_mini
  source-path: skills/symbolic-motion.md
---
